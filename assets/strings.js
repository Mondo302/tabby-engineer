...
window.STRINGS = {
  en: {
    ...
    // Amounts are the prototype's illustrative ones (scenarios.js).
    'cinema.label': 'Her case, played through',
    'cinema.skip': 'Skip the story',
    'cinema.modeToday': 'Today',
    'cinema.modeProposed': 'Proposed',
    'cinema.s1.title': 'Another purchase.',
    'cinema.s1.text': 'SAR 900 this time. She has never paid late. She taps Buy.',
    'cinema.s2.title': 'Checkout.',
    'cinema.s2.text': 'Four instalments. Nothing unusual. She taps Pay.',
    'cinema.s3.title': 'A moment.',
    'cinema.s3.text': 'A second or two, then the answer.',
    'cinema.s4.title': 'This is where it ended for her.',
    'cinema.s4.text': 'Declined. No reason, no date, no next step. Try again later.',
    'cinema.s5.title': 'The same decline, told properly.',
    'cinema.s5.text': 'Still a no. But it says why, and when it will be looked at again.',
    'cinema.s6.title': 'Her limit, in the open.',
    'cinema.s6.text': 'What it is, when it is reviewed, and that nothing is needed from her.',
    'cinema.s7.title': 'The message she never got.',
    'cinema.s7.text': 'In her case it just started working again. Here, she is told: reviewed, and restored.',
    'cinema.s8.title': 'Your turn.',
    'cinema.s8.text': 'Pick a case, switch between Today and Proposed, tap Buy.',
  ...
  ar: {
    ...
    'cinema.label': 'قصتها، مشهدًا بعد مشهد',
    'cinema.skip': 'تخطَّ القصة',
    'cinema.modeToday': 'اليوم',
    'cinema.modeProposed': 'المقترح',
    'cinema.s1.title': 'عملية شراء أخرى.',
    'cinema.s1.text': '900 ريال هذه المرة. لم تتأخر يومًا عن السداد. تضغط «اشترِ».',
    'cinema.s2.title': 'الدفع.',
    'cinema.s2.text': 'أربعة أقساط. لا شيء غير عادي. تضغط «ادفع».',
    'cinema.s3.title': 'لحظة.',
    'cinema.s3.text': 'ثانية أو ثانيتان، ثم يأتي الرد.',
    'cinema.s4.title': 'هنا انتهى الأمر بالنسبة إليها.',
    'cinema.s4.text': 'رُفضت. بلا سبب ولا موعد ولا خطوة تالية. يرجى المحاولة لاحقًا.',
    'cinema.s5.title': 'الرفض نفسه، لكن بشرح واضح.',
    'cinema.s5.text': 'ما زال الجواب لا. لكنه يقول لماذا، ومتى تكون المراجعة القادمة.',
    'cinema.s6.title': 'حد الإنفاق، أمام عينيها.',
    'cinema.s6.text': 'كم هو، ومتى تتم مراجعته، وأنه لا يُطلب منها أي شيء.',
    'cinema.s7.title': 'الرسالة التي لم تصلها قط.',
    'cinema.s7.text': 'في حالتها عادت الدفعات تعمل فجأة من تلقاء نفسها. هنا يُقال لها: تمت المراجعة، وأُعيد الحد.',
    'cinema.s8.title': 'دورك الآن.',
    'cinema.s8.text': 'اختر حالة، وبدّل بين «اليوم» و«المقترح»، واضغط «اشترِ».',
